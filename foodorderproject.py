...
class RoyalRestaurant:
    ...
    def add_food_item(self):
        try:
            ...
            quantity = eval(input("Enter the quantity in values only : "))
            price = eval(input("Enter the price in Rs only : "))
            discount = eval(input("Enter the discount in Rs only : "))
            stock = eval(input("Enter the available stock in values only : "))
...
try:
    def main():
        obj = RoyalRestaurant("The Royal Kitchen")
